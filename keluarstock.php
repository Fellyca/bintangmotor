    ...
    <body class="sb-nav-fixed">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        <?php
                                            $ambilsemuadatakeluar = mysqli_query($conn, "select * from orderan");
                                            while($data=mysqli_fetch_array($ambilsemuadatakeluar)){
                                                $idorder = "NTJL".$data['idorder'];
                                                $tanggal = $data['tanggal'];
                                                $namapembeli = $data['pembeli'];
                                                $nohp = $data['nohp'];
                                        ?>
                                        <tr>
                                            <td> <?=$idorder;?> </td>
                                            ...
                                            <td> <?=$nohp;?> </td>
                                            <td>
                                                <a type="button" class="btn btn-primary" href="view.php?idp=<?=$data['idorder'];?>">
                                                    Detail
                                                </a>
                                        ...
                                        <div class="modal fade" id="delete<?=$idorder;?>">
                                            <div class="modal-dialog">
                                                ...
                                                <div class="modal-body">
                                                    Apakah Anda yakin ingin menghapus <?=$idorder;?>?
                                                    <input type="hidden" name="idorder" value="<?=$data['idorder'];?>">
                                                    <br>
                                                    <br>
                                                    <button type="submit" class="btn btn-danger" name="hapusnota">Hapus</button>
                                                </div>
                                                </form>
        ...
        <div class="modal fade" id="myModal">
            <div class="modal-dialog">
                ...
                <form method="post">
                <div class="modal-body">
                    <input type="text" name="pembeli" placeholder="Nama Pembeli" class="form-control" require>
                    <br>
                    <input type="text" name="nohp" placeholder="No HP" class="form-control">
                    <br>
                    <button type="submit" class="btn btn-primary" name="nota">Submit</button>
                </div>
                </form>
